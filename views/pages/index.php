        ...
        <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              ...
              <div id="id_user" data-datac="<?php if (isset($_SESSION['id'])) echo $_SESSION['id'];?>"></div>
  ...
  <section class="feature_section  layout_padding">
    <div class="container">
      <div class="feature_container">
        ...
        <div class="box">
          <div class="img-box">
            <svg id="Capa_3" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512"
        ...
        <div class="owl-carousel">
          ...
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="<?php echo $product['img'];?>" width="250px" height="270px" alt="">
              </div>
              <div class="detail-box">
                <div class="text">
                  <h6>
